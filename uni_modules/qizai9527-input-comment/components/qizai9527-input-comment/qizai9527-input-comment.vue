<template>
	<view :style="'display: '+ showType">
		<view @click="clickOther" class="qizai9527-comment-other"></view>
		<view class="qizai9527-comment">
			<view class="qizai9527-comment-info">
				<textarea v-model="value" :placeholder="placeholder" :focus="isShow" auto-height="true" />
				<view @click.stop="submitComment" class="qizai9527-comment-submit" :style="'color:'+submitColor">发布
				</view>
			</view>
		</view>
	</view>
